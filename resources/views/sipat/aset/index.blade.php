                    ...
                    @forelse($asetTanah as $index => $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- 2. NIBAR & Status Pencatatan (Sub-teks Halus di Bawah) -->
                                <div class="mt-1 d-flex align-items-center gap-2 flex-wrap" style="font-size: 0.73rem;">
                                    ...
                                    @elseif(!empty($item->kode_aset) && $item->kode_aset !== '-')
                                    ...
                                    @else
                                        <span class="text-muted fst-italic">
                                            <i class="bi bi-dash-circle text-secondary opacity-50 me-1"></i>Tanpa NIBAR
                                        </span>
                                    @endif

                                    @if($item->status_pencatatan === 'USULAN_BELUM_TERCATAT')
                                        <span class="badge bg-danger-subtle text-danger border border-danger-subtle px-1.5 py-0.2" style="font-size: 0.65rem;">Belum KIB A</span>
                                    @endif
                                </div>
                            </td>
                            <td>
...
<script>
    ...
    // Copy NIBAR Helper with visual icon feedback
    document.addEventListener('click', function(e) {
        ...
        if (nibar && navigator.clipboard) {
            navigator.clipboard.writeText(nibar).then(() => {
                ...
                // Fallback jika permission error
