...
@section('title', 'Edit Surat Penyerahan - eLABEL')
...
<div class="container-fluid px-0">
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1 small">
                    ...
                    <li class="breadcrumb-item active text-navy fw-medium" aria-current="page">Edit Surat</li>
                </ol>
            </nav>
            <h4 class="fw-bold text-navy mb-0">Edit Surat Penyerahan {{ $item->no_surat }}</h4>
        </div>
        <div>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            <form action="{{ route('elabel.surat-penyerahan.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="no_surat" value="{{ old('no_surat', $item->no_surat) }}" class="form-control" required>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="jenis_penyerahan" value="{{ old('jenis_penyerahan', $item->jenis_penyerahan) }}" class="form-control">
                    </div>

                    <div class="col-md-4">
                        <label class="form-label fw-semibold small">Pemberi Hibah / Instansi</label>
                        <input type="text" name="pemberi_hibah" value="{{ old('pemberi_hibah', $item->pemberi_hibah) }}" class="form-control">
                    </div>
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-semibold small">Ganti Scan Surat Penyerahan (PDF Max 50MB)</label>
