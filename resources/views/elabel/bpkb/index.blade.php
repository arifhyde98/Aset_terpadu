                                ...
                                <div class="d-flex justify-content-center gap-1">
                                    @if($item->pdf_path)
                                        @if(str_starts_with($item->pdf_path, 'tg:'))
                                            <a href="{{ route('elabel.bpkb.view-pdf', $item->id) }}" target="_blank" class="btn btn-sm btn-info text-white border-0 shadow-sm fw-medium d-inline-flex align-items-center gap-1" title="Disimpan & Dibuka dari Telegram Cloud Storage">
