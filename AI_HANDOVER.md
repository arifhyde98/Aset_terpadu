...
- **Pusat Laporan Aset Tanah & Ekspor Resmi 11 Kolom**: Filter laporan terstruktur berbasis 5 Kategori Status Sertifikasi (Belum Diproses, Dalam Proses BPN, Sudah Bersertifikat, Bermasalah/Sengketa, serta Belum Bersertifikat Gabungan) lengkap dengan **22 Aset Tanah Bermasalah** yang telah disinkronkan status dan keterangan catatannya di database. Mendukung **Auto-Terapkan Filter** secara instan saat mengubah opsi OPD, Kategori Status, Tanggal Perolehan, maupun Judul Laporan. Format tabel laporan dan ekspor resmi mengadopsi standar 11 kolom Pemerintah Kabupaten Donggala: **NO., Kode Aset / NIBAR, Nama Barang, Lokasi, Aset Tanah (Bidang, Luas(m2), Nilai(Rp)), Tanggal Perolehan, Cara Perolehan, Status (Status Proses BPN terkini), dan Keterangan** (kolom keterangan dikunci ketat hanya memuat catatan riil keterangan aset dari database, bukan nama barang/nama aset). Selaras 100% pada tampilan Pratinjau Web (`/sipat/laporan`), Dokumen Cetak/Unduh PDF (mPDF A4-L), serta Berkas Ekspor Excel (.xlsx).
