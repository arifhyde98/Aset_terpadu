...
class UpdateBangunanRequest extends FormRequest
{
    ...
    {
        // Kunci instansi OPD bagi role OPD
    ...
    {
        $bangunanId = $this->route('bangunan')?->id ?? $this->route('bangunan');
        ...
        return [
            ...
            'kode_bangunan'       => [
                ...
                'string',
                'max:50',
                Rule::unique('aset_bangunan', 'kode_bangunan')->ignore($bangunanId),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'kode_bangunan.unique'   => 'Kode bangunan ini sudah terdaftar pada aset lain.',
